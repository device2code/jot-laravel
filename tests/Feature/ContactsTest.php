...
class ContactsTest extends TestCase
{
    ...
    {        
        ...
        $this->assertEquals('06/11/1980', $contact->birthday->format('m/d/Y'));
    ...
    public function birthdays_are_properly_stored()
    {
        ...
        $this->assertEquals('06-11-1980', Contact::first()->birthday->format('m-d-Y'));
    }
    ...
    /** @test */
    public function only_the_users_contacts_can_br_retrieved()
    {
        $contact = factory(Contact::class)->create(['user_id' => $this->user->id]);
    ...
    /** @test */
    public function a_contact_can_deleted()
    {
        $contact = factory(Contact::class)->create();
